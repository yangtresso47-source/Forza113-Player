...
class KuqforzaDatabaseMigrationTest {

    private val testDbName = "kuqforza-migration-test"
    ...
    fun migrate1To39_fullChainValidatesLatestSchema() {
        migrationTestHelper.createDatabase("kuqforza-full-chain-test", 1).close()

        migrationTestHelper.runMigrationsAndValidate(
            "kuqforza-full-chain-test",
            39,
            true,
    ...
    fun migrate38To39_addsStalkerProviderColumnsAndUniqueIndex() {
        migrationTestHelper.createDatabase("kuqforza-38-39-test", 38).apply {
            execSQL(
                """
    ...
    fun migrate32To33_backfillsMovieWatchCountAndAddsGlobalFavoritesIndex() {
        migrationTestHelper.createDatabase("kuqforza-32-33-test", 32).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate33To34_addsSuccessTimestampsAndProgramsEndTimeIndex() {
        migrationTestHelper.createDatabase("kuqforza-33-34-test", 33).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate34To35_createsSearchHistoryTable() {
        migrationTestHelper.createDatabase("kuqforza-34-35-test", 34).close()
    ...
    fun migrate31To32_scopesFavoritesAndSplitsMixedProviderGroups() {
        migrationTestHelper.createDatabase("kuqforza-31-32-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate31To32_assignsLegacyGroupsWhenNoProviderIsActive() {
        migrationTestHelper.createDatabase("kuqforza-31-32-no-active-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate35To36_addsProgramRemindersAndEpgMatchMetadata() {
        migrationTestHelper.createDatabase("kuqforza-35-36-test", 35).close()
    ...
    fun migrate36To37_createsTmdbIdentityTable() {
        migrationTestHelper.createDatabase("kuqforza-36-37-test", 36).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate14To15_addsAuditCompletionColumns() {
        migrationTestHelper.createDatabase("kuqforza-14-15-test", 14).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
