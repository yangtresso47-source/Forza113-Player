...
import com.kuqforza.iptv.ui.screens.dashboard.DashboardScreen
import com.kuqforza.iptv.ui.screens.multiview.MultiViewScreen
import com.kuqforza.iptv.ui.screens.home.HomeScreen
import com.kuqforza.iptv.ui.screens.movies.MoviesScreen
import com.kuqforza.iptv.ui.screens.player.PlayerScreen
import com.kuqforza.iptv.ui.screens.provider.ProviderSetupScreen
import com.kuqforza.iptv.ui.screens.series.SeriesScreen
import com.kuqforza.iptv.ui.screens.settings.SettingsScreen
import com.kuqforza.iptv.ui.screens.welcome.WelcomeScreen
            ...
            DashboardScreen(
                ...
                onRecentChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = com.kuqforza.domain.model.VirtualCategoryIds.RECENT,
                ...
                onFavoriteChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = com.kuqforza.domain.model.VirtualCategoryIds.FAVORITES,
                            providerId = channel.providerId,
                            isVirtual = true,
                            combinedProfileId = combinedProfileId,
                            returnRoute = Routes.HOME
                ...
                onPlaybackHistoryClick = { history ->
                    val route = when (history.contentType) {
                        com.kuqforza.domain.model.ContentType.LIVE -> {
                            Routes.player(
                        ...
                        com.kuqforza.domain.model.ContentType.MOVIE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
                        ...
                        com.kuqforza.domain.model.ContentType.SERIES -> {
                            Routes.seriesDetail(history.contentId, Routes.HOME)
                        }
                        com.kuqforza.domain.model.ContentType.SERIES_EPISODE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
...
// ... (rest of file)
        ...
        composable(
            ...
            com.kuqforza.iptv.ui.screens.epg.FullEpgScreen(
        ...
        composable(
            ...
            com.kuqforza.iptv.ui.screens.settings.parental.ParentalControlGroupScreen(
                currentRoute = Routes.SETTINGS,
                onNavigate = { route -> tabNavigate(route) },
                onBack = { navController.popBackStack() }
            )
        ...
        composable(
            ...
            com.kuqforza.iptv.ui.screens.search.SearchScreen(
        ...
        composable(
            ...
            com.kuqforza.iptv.ui.screens.movies.MovieDetailScreen(
                onPlay = { movie ->
                    navController.navigateToPlayer(
        ...
        composable(
            ...
            com.kuqforza.iptv.ui.screens.series.SeriesDetailScreen(
