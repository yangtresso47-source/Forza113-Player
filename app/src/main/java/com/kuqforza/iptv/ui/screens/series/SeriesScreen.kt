package com.kuqforza.iptv.ui.screens.series
...
import com.kuqforza.iptv.ui.components.SavedCategoryContextCard
import com.kuqforza.iptv.ui.components.SavedCategoryShortcut
import com.kuqforza.iptv.ui.components.SavedCategoryShortcutsRow
...
import com.kuqforza.iptv.ui.components.ReorderTopBar
import com.kuqforza.iptv.ui.components.dialogs.DeleteGroupDialog
...
import com.kuqforza.iptv.ui.components.shell.VodActionChip
import com.kuqforza.iptv.ui.components.shell.VodActionChipRow
import com.kuqforza.iptv.ui.components.shell.VodCategoryOption
import com.kuqforza.iptv.ui.components.shell.VodCategoryPickerDialog
import com.kuqforza.iptv.ui.components.shell.VodBrowseOptionsDialog
import com.kuqforza.iptv.ui.components.shell.VodClassicCategoryOption
import com.kuqforza.iptv.ui.components.shell.VodClassicContentHeader
import com.kuqforza.iptv.ui.components.shell.VodClassicSplitLayout
import com.kuqforza.iptv.ui.components.shell.VodHeroStrip
import com.kuqforza.iptv.ui.components.shell.VodSectionHeader
import com.kuqforza.iptv.ui.design.FocusRestoreHost
import com.kuqforza.iptv.ui.design.requestFocusSafely
import com.kuqforza.iptv.ui.model.VodViewMode
import com.kuqforza.iptv.ui.screens.vod.HandleVodUserMessage
import com.kuqforza.iptv.ui.screens.vod.ProtectedVodPinDialog
import com.kuqforza.iptv.ui.screens.vod.VodBrowseDefaults
import com.kuqforza.iptv.ui.screens.vod.vodActiveFilterSortDetail
...
fun SeriesScreen(
    ...
    if (uiState.showDialog && uiState.selectedSeriesForDialog != null) {
        ...
        com.kuqforza.iptv.ui.components.dialogs.AddToGroupDialog(
    ...
    if (uiState.selectedCategoryForOptions != null) {
        ...
        com.kuqforza.iptv.ui.components.dialogs.CategoryOptionsDialog(
            category = category,
        ...
        buildMap<String, Category> {
            ...
            put(
                ...
                Category(
                    ...
                    type = com.kuqforza.domain.model.ContentType.SERIES,
                    isVirtual = true
                )
            )
        }
